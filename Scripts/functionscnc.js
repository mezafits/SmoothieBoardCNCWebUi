    ...
    runCommandCallback("M20",function(a)
    {
        $.each(a.split("\n"), function (c) {
            ...
            if (e.match(/\.g(code)?$/))
            {
                ...
                var g = d.insertRow(-1); var b = g.insertCell(0);
                var f = document.createTextNode(e); b.appendChild(f);
                b = g.insertCell(1); b.innerHTML = "[<a href='javascript:void(0);' onclick='playFile(\"" + e + "\");'>Play</a>]"
            }
        })
    })
    };
